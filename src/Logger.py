...
def handle_logs(error_type, error_message):
    ...
    error_log = f"""\n{file_handlers.date_string_formatted} {file_handlers.datatime_information_set.hour}:{file_handlers.datatime_information_set.minute} - {error_type} - {error_message} - {inspect.stack()[1][3]}"""
